    ...
    public class JsonDictionaryModelBinder : IModelBinder
    {
        ...
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if (bindingContext.ModelType == typeof(JsonDictionary))
            {
                ...
                this.addRequestValues(model, controllerContext.RequestContext.HttpContext.Request.Form, controllerContext, bindingContext);

                // Check/Add QueryString Collection
                this.addRequestValues(model, controllerContext.RequestContext.HttpContext.Request.QueryString, controllerContext, bindingContext);
            }
